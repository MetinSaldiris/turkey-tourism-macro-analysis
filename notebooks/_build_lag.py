...
cells.append(nbf.v4.new_markdown_cell(
    ...
    "N = 73) peaks at lag +1 with ρ = +0.721 — Russian search intent leads "
    "arrivals by one month in the pre-war holiday regime. Post-2022-02 "
    "(N = 45) peaks at lag −5 with ρ = −0.727 — search now lags arrivals by "
...
cells.append(nbf.v4.new_markdown_cell(
    ...
    "printout below): DE peaks at lag −6 with ρ = +0.622, GB at lag 0 with "
    "ρ = +0.459, RU at lag 0 with ρ = +0.470, all on N = 106. The full shape is:\n"
    "\n"
    ...
    "  not survive. Lag +1 is still significant (ρ = +0.292) but is not the peak. "
    "  The two YoY series co-move over a slow window rather than through a "
    "  one-month lead structure.\n"
    "- **GB**: near-symmetric shape around **lag 0** (peak ρ = +0.459, with "
    ...
    "- **RU (full sample, YoY)**: peaks at lag 0 with ρ = +0.470. The raw "
    ...
    "  peak at lag −5 with ρ = −0.73 (arrivals rise while search falls, "
